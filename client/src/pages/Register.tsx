    ...
    <div className="min-h-screen flex items-center justify-center bg-neutral-50 px-4 py-8">
      <Card className="w-full max-w-sm">
        <CardHeader>
          ...
          <CardDescription>Set up your organization on the GHG Emissions Calculator</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <p className="text-sm text-neutral-600 mt-4 text-center">
            ...
            <Link href="/login" className="text-primary-600 hover:text-primary-800 underline">
              Log in
            </Link>
          </p>
        </CardContent>
