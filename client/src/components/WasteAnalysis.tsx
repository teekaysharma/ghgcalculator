...
export default function WasteAnalysis({ emissions, enabled }: WasteAnalysisProps) {
  ...
  useEffect(() => {
    const hasWaste = emissions.some((emission) => emission.wasteType && emission.disposalMethod);
  ...
  const calculateWasteSummary = () => {
    ...
    const wasteEmissions = emissions.filter((emission) => emission.wasteType && emission.disposalMethod);
        ...
        <CardContent className="pt-6 text-center py-12">
          <div className="flex flex-col items-center justify-center text-neutral-500">
            ...
            <p className="text-sm max-w-md">
              To enable waste analysis, please upload a waste-specific emission factors file and assign waste types and
              disposal methods to your emissions.
            </p>
          </div>
        </CardContent>
      </Card>
          ...
          <div className="flex items-center mb-4">
            ...
            <div>
              <h4 className="text-lg font-semibold">
                {totalWasteEmissions.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}{" "}
                kg CO₂e
              </h4>
                  ...
                  {wasteSummary.map((waste, index) => (
                    <tr key={index} className={index % 2 === 0 ? "bg-white" : "bg-neutral-50"}>
                      ...
                      <td className="px-4 py-3 whitespace-nowrap text-sm text-neutral-600">
                        {waste.totalQuantity.toLocaleString(undefined, {
                          ...
                          {Object.entries(waste.byMethod).map(([method, emission], i) => (
                            <div key={i} className="flex justify-between">
                              ...
                              <span className="font-medium">
                                {emission.toLocaleString(undefined, {
                                  minimumFractionDigits: 2,
                                  maximumFractionDigits: 2,
                                })}{" "}
                                kg CO₂e
                      ...
                      <td className="px-4 py-3 whitespace-nowrap text-sm font-medium text-neutral-800">
                        {waste.totalEmission.toLocaleString(undefined, {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2,
                        })}{" "}
                        kg CO₂e
