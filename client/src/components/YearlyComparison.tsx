        ...
        <CardContent className="pt-6 text-center py-12">
          <div className="flex flex-col items-center justify-center text-neutral-500">
            ...
            <p className="text-sm max-w-md">
              To enable yearly comparison, please add year information to your emission activities using the "Track by
              Year" option in the advanced settings.
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        <div className="mb-4">
          {totalIncreasePercent !== null && (
            <div className="flex items-center mb-4 p-3 bg-neutral-50 rounded-md">
              <div
                className={`rounded-full p-2 mr-3 ${totalIncreasePercent > 0 ? "bg-red-100 text-red-600" : "bg-green-100 text-green-600"}`}
              >
